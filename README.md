...
Project Title & Group Name: Basic identification.
Task Selection: Enter task number from the predefined menu(1-5). Enter 0 to stop adding tasks.
Member Name: Assign a name to the task.
Status: Type done or pending.
Execution: The script processes these inputs using a loop, stores the data in a list or dictionary, and performs the mathematical logic  
defined in the sample output.
View Output: the program prints the final summary table and status report to the console.
Logic Rules Summary
