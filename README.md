...
1. Prepare the Environment: Ensure you have the programming language interpreter installed on your machine.
2. Input Data: The program prompts for the following in sequence:
